...
-- AlterEnum
BEGIN;
CREATE TYPE "UserRole_new" AS ENUM ('VISITOR', 'TKJ1', 'TKJ2', 'TKJ3', 'INSTRUCTOR');
ALTER TABLE "User" ALTER COLUMN "role" DROP DEFAULT;
ALTER TABLE "User" ALTER COLUMN "role" TYPE "UserRole_new" USING ("role"::text::"UserRole_new");
ALTER TABLE "CourseMembership" ALTER COLUMN "role" TYPE "UserRole_new" USING ("role"::text::"UserRole_new");
